...
public class FollowerAdapter extends RecyclerView.Adapter<FollowerAdapter.PopularViewHolder> {

    private Context mCtx;
//    private List<UserInfo> youmayLikeList;
    private List<UserInfo> otherfollowing;

    public FollowerAdapter(Context mCtx, List<UserInfo> youmayLikeList_) {
        this.mCtx = mCtx;
        this.otherfollowing = youmayLikeList_;
    }

    @Override
    public FollowerAdapter.PopularViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.custom_follower_list, null);
        return new FollowerAdapter.PopularViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final FollowerAdapter.PopularViewHolder holder, int position) {
