...
import com.example.fwprld.ui.activities.RecordingListActivity;
...
public class RecordingAdapter extends RecyclerView.Adapter<RecordingAdapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            imageViewPlay = itemView.findViewById(R.id.imgPlayIcon);
            seekBar = itemView.findViewById(R.id.seekBarPlay);
            textViewName = itemView.findViewById(R.id.txtAudioFileName);
