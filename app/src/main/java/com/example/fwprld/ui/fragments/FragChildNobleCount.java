...
public class FragChildNobleCount extends Fragment implements View.OnClickListener {
    View view;
//    TextView txtuserid,txtbio,tvContribute,tvStatus,tvGallery,tvTopFun;
//    RelativeLayout rlTopFun,rlContribute;
//    String user_id;
    public FragChildNobleCount() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.frag_noble_count, container, false);
