...
public class FragChildNobleDuke extends Fragment implements View.OnClickListener {
    View view;
//    TextView txtuserid,txtbio,tvContribute,tvStatus,tvGallery,tvTopFun;
//    RelativeLayout rlTopFun,rlContribute;
//    String user_id;
    public FragChildNobleDuke() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.frag_noble_duke, container, false);
