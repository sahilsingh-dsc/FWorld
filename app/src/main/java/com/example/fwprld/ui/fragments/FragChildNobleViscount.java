...
public class FragChildNobleViscount extends Fragment implements View.OnClickListener {
    View view;
//    TextView txtuserid,txtbio,tvContribute,tvStatus,tvGallery,tvTopFun;
//    RelativeLayout rlTopFun,rlContribute;
//    String user_id;
    public FragChildNobleViscount() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.frag_noble_vis_count, container, false);
